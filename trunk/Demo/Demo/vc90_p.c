...
extern const MIDL_SERVER_INFO IEventSource_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IEventSource_ProxyInfo;
...
CINTERFACE_PROXY_VTABLE(8) _IEventsProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IEvents::MyEvent */
};
...
/* Object interface: IEventSource, ver. 0.0,
   GUID={0x00000000,0x0000,0x0000,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02}} */

#pragma code_seg(".orpc")
static const unsigned short IEventSource_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IEventSource_ProxyInfo =
    {
    &Object_StubDesc,
    vc90__MIDL_ProcFormatString.Format,
    &IEventSource_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IEventSource_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    vc90__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IEventSourceProxyVtbl = 
{
    &IEventSource_ProxyInfo,
    &IID_IEventSource,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IEventSource::FireEvent */
};


static const PRPC_STUB_FUNCTION IEventSource_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IEventSourceStubVtbl =
{
    &IID_IEventSource,
    &IEventSource_ServerInfo,
    8,
    &IEventSource_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * _vc90_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_IEventSourceProxyVtbl,
    0
};
